...
class SlotFormerParams(BaseParams):
    ...
    # data settings
    dataset = 'maniskill_slots'
    data_root = './data/maniskill'
    slots_root = './data/slot.pkl'
    ...
    dec_dict = dict(
        ...
        dec_ks=5,
        dec_norm='',
        dec_ckp_path='/home/jialin/repo23/NeuralSimulation/baselines/SlotFormer/checkpoint/savi_maniskill2_params/models/model_82674.pth',
    )
